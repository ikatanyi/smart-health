package io.smarthealth.financial.account.service.impl;
...
import io.smarthealth.financial.account.domain.JournalEntryRepository;
...
public class JournalBalanceUpdateServiceImpl implements JournalBalanceUpdateService {
    ...
    private BigDecimal calculateRunningBalance(JournalEntry entry, Map<Long, BigDecimal> runningBalanceMap) {
        ...
        AccountType accountType = AccountType.valueOf(entry.getAccount().getType());
