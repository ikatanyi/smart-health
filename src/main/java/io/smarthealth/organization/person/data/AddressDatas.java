...
@Data
public final class AddressDatas {
    private Long id;
    ...
    public static PersonAddress map(final AddressDatas address) {
    ...
    public static AddressDatas map(final PersonAddress addressEntity) {
        final AddressDatas address = new AddressDatas();
