...
//        return "Patient Bill[id=" + getId() + ", patient number=" + patient!=null ? patient.getPatientNumber(): null + " , bill number=" +billNumber+ ", payment mode=" +paymentMode+ ", transaction id=" + transactionId + ", amount=" +amount+ ",  ]";
//    }
}
