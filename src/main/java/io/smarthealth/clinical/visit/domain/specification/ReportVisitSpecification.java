 ...
 * @author simz
 */
public class ReportVisitSpecification {

    private ReportVisitSpecification() {
        super();
    }

    public static Specification<Visit> createSpecification(String visitNumber, Employee employee, ServicePointsss servicePoint, Patient patient, String patientName, Boolean visitIsRunning, DateRange dateRange) {
        ...
        return (root, query, cb) -> {
            ...
            query.groupBy(root.get("visitNumber"));
