...
public interface MohRepository extends JpaRepository<Moh, Long>, JpaSpecificationExecutor<Moh> {
    ...
    @Query(value = "SELECT"
            ...
            + "     MAX(case when DAYOFMONTH(d.date_recorded) = 2 then (select count(pd.m_code) FROM patient_diagnosis pd WHERE DAYOFMONTH(pd.date_recorded)='2' pd.m_code=m.code) else 0 end) AS day2,"
            + "     MAX(case when DAYOFMONTH(d.date_recorded) = 3 then (select count(pd.m_code) FROM patient_diagnosis pd WHERE DAYOFMONTH(pd.date_recorded)='3' pd.m_code=m.code) else 0 end) AS day3,"
            + "     MAX(case when DAYOFMONTH(d.date_recorded) = 4 then (select count(pd.m_code) FROM patient_diagnosis pd WHERE DAYOFMONTH(pd.date_recorded)='4' pd.m_code=m.code) else 0 end) AS day4,"
            + "     MAX(case when DAYOFMONTH(d.date_recorded) = 5 then (select count(pd.m_code) FROM patient_diagnosis pd WHERE DAYOFMONTH(pd.date_recorded)='5' pd.m_code=m.code) else 0 end) AS day5,"
            + "     MAX(case when DAYOFMONTH(d.date_recorded) = 6 then (select count(pd.m_code) FROM patient_diagnosis pd WHERE DAYOFMONTH(pd.date_recorded)='6' pd.m_code=m.code) else 0 end) AS day6,"
            + "     MAX(case when DAYOFMONTH(d.date_recorded) = 7 then (select count(pd.m_code) FROM patient_diagnosis pd WHERE DAYOFMONTH(pd.date_recorded)='7' pd.m_code=m.code) else 0 end) AS day7,"
            + "     MAX(case when DAYOFMONTH(d.date_recorded) = 8 then (select count(pd.m_code) FROM patient_diagnosis pd WHERE DAYOFMONTH(pd.date_recorded)='8' pd.m_code=m.code) else 0 end) AS day8,"
            + "     MAX(case when DAYOFMONTH(d.date_recorded) = 9 then (select count(pd.m_code) FROM patient_diagnosis pd WHERE DAYOFMONTH(pd.date_recorded)='9' pd.m_code=m.code) else 0 end) AS day9,"
