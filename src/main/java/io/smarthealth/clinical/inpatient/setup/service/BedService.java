...
import io.smarthealth.clinical.inpatient.setup.data.BedChargeData;
import io.smarthealth.clinical.inpatient.setup.data.BedData;
import io.smarthealth.clinical.inpatient.setup.domain.Bed;
import io.smarthealth.clinical.inpatient.setup.domain.BedCharge;
import io.smarthealth.clinical.inpatient.setup.domain.BedRepository;
