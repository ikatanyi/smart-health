...
public class EmailData {
    ...
    public EmailData(String from, String toList, String subject, String message) {
        this();
        this.from = from;
    ...
    public EmailData(String from, String toList, String ccList) {
        this();
        this.from = from;
        this.to = splitByComma(toList);
    ...
    public EmailData(String from, String toList) {
        this();
        this.from = from;
        this.to = splitByComma(toList);
    }

    public EmailData(String from, String toList, String ccList, String subject, String message) {
        this();
        this.from = from;
        this.subject = subject;
        this.message = message;
