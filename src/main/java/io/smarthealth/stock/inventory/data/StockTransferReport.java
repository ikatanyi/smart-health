...
public class StockTransferReport extends StockTransferData{
    ...
    public StockTransferReport(StockTransferData data) {
        super(data.getTransferNo(), data.getCachedQuantity(), data.getSourceStoreId(), data.getSourceStore(), data.getDestinationStoreId(), data.getDestinationStore(), data.getNotes(), data.getStatus(), data.getCreatedAt(), data.getReceivedAt());
    }
